...
/**
 * Graphical class handling all visualisation tasks - this includes setting and interacting with the user interface controls, 
 * drawing the graphs and the animations as a search or searches are running.
 * 
 * Also acts as view in MVC
...
public class GUI extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Graph graph = ExampleGraphs.planarGraph15();
